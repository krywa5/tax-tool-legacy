...
class Germany extends Component {
    ...
    componentDidUpdate(previousProps, previousState) {
        ...
        if ((previousState.startDate !== this.state.startDate || previousState.endDate !== this.state.endDate || previousState.daysInPoland !== this.state.daysInPoland) && (this.state.startDate && this.state.endDate) && this.state.endDate[0] === '2') {
        ...
        return (<
            ...
            div className="input-box-inputs" >
                < label htmlFor="income" > Przychód brutto(EUR) < br /> < span > {
                    ...
                    >
                    <
            /div> <div className="input-box-inputs" >
                        <
            label htmlFor="holidayIncome" > Przychód wakacyjny(EUR) < br /> < span > {
                                germany.holidayIncome
                            } < /span></label >
                            <
                                input value={
            ...
            label htmlFor="currencyValue" > Średni kurs waluty < br /> {
                ...
                div className="input-box-inputs results" >
                                                                                                    <
                label htmlFor="allIncomeValue" > Wartość przychodu(PLN) < br /> < span > < strong > PIT - ZG pole nr 8 < /strong><br /> PIT - ZG pole nr 9,
                                                                                                        10 = 0,
                sprawdzić pole nr 199 < /span></label >
                                                                                                            <
                                                                                                                input
                                                                                                                type="number"
                                                                                                                readOnly
                                                                                                                id="allIncomeValue"
                                                                                                                value={
                                                                                                                    this.state.currencyValue ? ((this.state.income + this.state.holidayIncome - this.state.workDays * this.state.allowanceValue) * this.state.currencyValue - (this.state.workMonths * this.state.monthlyIncomeCost)).toFixed(2) : ''
                                                                                                                }
                                                                                                            /> < /
                div > <
                /div>
