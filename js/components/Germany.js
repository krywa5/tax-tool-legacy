        ...
        return (
            <div className="input-box">
                <div className="input-box-inputs">
                    <label htmlFor="income">Przychód brutto (EUR)<br /><span>{germany.income}</span></label>
                    <input
                ...
                <div className="input-box-inputs">
                    <label htmlFor="holidayIncome">Przychód wakacyjny (EUR)<br /><span>{germany.holidayIncome}</span></label>
                    <input
                ...
                <div className="input-box-inputs results">
                    ...
                    <input
                        ...
                        readOnly
                        id="allIncomeValue"
                        value={this.state.currencyValue ? ((this.state.income + this.state.holidayIncome - this.state.workDays * this.state.allowanceValue) * this.state.currencyValue - (this.state.workMonths * this.state.monthlyIncomeCost)).toFixed(2) : ''}
                    />
                </div>
            </div>
        );
